...
//   npx tsx scripts/receipt-enrichment/engines/walmart-enrich/_probe-baseline.ts > <somewhere>/baseline.txt
...
const PATHS = [`${WM.out}/sams/preview_splits.csv`, `${WM.out}/preview_splits.csv`];
