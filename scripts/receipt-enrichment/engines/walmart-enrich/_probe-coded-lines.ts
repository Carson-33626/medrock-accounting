...
//   npx tsx scripts/receipt-enrichment/engines/walmart-enrich/_probe-coded-lines.ts
...
const TARGETS: { tag: string; path: string }[] = [
  { tag: "SAM'S", path: `${WM.out}/sams/preview_splits.csv` },
  { tag: 'WALMART', path: `${WM.out}/preview_splits.csv` },
];
