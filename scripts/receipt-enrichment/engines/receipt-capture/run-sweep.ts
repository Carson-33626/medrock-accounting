// web/scripts/receipt-enrichment/engines/receipt-capture/run-sweep.ts
...
//   npx tsx scripts/receipt-enrichment/engines/receipt-capture/run-sweep.ts [--dry-run] [--vendor toprx,uline,amazon,walmart,sams,amazon-csv] [--limit N] [--skip-scan]
