...
//
// Usage (from web/):
//   npx tsx scripts/receipt-enrichment/engines/receipt-capture/scan-bill-vendors.ts
//   npx tsx scripts/receipt-enrichment/engines/receipt-capture/scan-bill-vendors.ts --since 2025-01-01 --top 40
//   npx tsx scripts/receipt-enrichment/engines/receipt-capture/scan-bill-vendors.ts --all --csv out/bill-vendors.csv
//
// Columns:
...
function parseArgs(argv: string[]): Args {
  ...
  return {
    ...
    csv: get('--csv') ?? `${RC.out}/bill-vendors.csv`,
  };
}
