...
//   npx tsx scripts/walmart-enrich/_probe-sams-suspense.ts scripts/walmart-enrich/out/sams/preview_splits.csv
...
const path = process.argv[2] ?? 'scripts/walmart-enrich/out/sams/preview_splits.csv';
