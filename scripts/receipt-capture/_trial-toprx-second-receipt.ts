...
//
//   npx tsx scripts/receipt-capture/_trial-toprx-second-receipt.ts          # dry-run, no write
//   npx tsx scripts/receipt-capture/_trial-toprx-second-receipt.ts --live   # ONE receipt upload
//
...
const PDF = 'scripts/receipt-capture/out/pdf/toprx-FL-4569499.pdf';
