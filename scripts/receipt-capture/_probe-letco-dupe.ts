...
// READ-ONLY.
//   npx tsx scripts/receipt-capture/_probe-letco-dupe.ts <FL|TN|TX> [invoiceNumber]
...
async function main(): Promise<void> {
  ...
  if (!entityArg || !ALL_ENTITIES.includes(entityArg as Entity)) {
    throw new Error('Usage: npx tsx scripts/receipt-capture/_probe-letco-dupe.ts <FL|TN|TX> [invoiceNumber]');
  }
