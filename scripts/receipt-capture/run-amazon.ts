// web/scripts/receipt-capture/run-amazon.ts
...
//   npx tsx scripts/receipt-capture/run-amazon.ts [--entity=FL] [--live] [--limit 5] [--pages 100]
...
const CACHE = 'scripts/amazon-enrich/.receipts_cache'; // shared with Engine A: 250+ PDFs already cached
