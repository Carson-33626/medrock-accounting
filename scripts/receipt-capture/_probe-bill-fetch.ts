...
//   npx tsx scripts/receipt-capture/_probe-bill-fetch.ts <entity> <billId>
...
async function main(): Promise<void> {
  ...
  if (!entityArg || !ALL_ENTITIES.includes(entityArg as Entity) || !billId) {
    throw new Error('Usage: npx tsx scripts/receipt-capture/_probe-bill-fetch.ts <FL|TN|TX> <billId>');
  }
