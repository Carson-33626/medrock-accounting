...
//   npx tsx scripts/receipt-capture/_verify-medisca-batch.ts
...
async function main(): Promise<void> {
  const registry = JSON.parse(readFileSync('scripts/receipt-capture/out/medisca-consumed.json', 'utf8')) as Registry;
