...
const THIRDS: Record<Entity, number> = { 'MedRock FL': 100 / 3, 'MedRock TN': 100 / 3, 'MedRock TX': 100 / 3 };
const FL_TN: Record<Entity, number> = { 'MedRock FL': 50, 'MedRock TN': 50, 'MedRock TX': 0 };
